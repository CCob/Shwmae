        ...
        public byte[] Decrypt(byte[] masterKey, byte[] entropy = null) {
            ...
            switch (HashAlgo) {
                ...
                case 32782: {
                        ...
                        var derivedKeyBytes = Crypto.DeriveKey(masterKey, Salt, HashAlgo, entropy);
                        ...
                        if (entropy != null) {
                            ...
                            return Crypto.DecryptBlob(Data, finalKeyBytes, CryptoAlgo, PaddingMode.PKCS7);
                        } else {
                            return Crypto.DecryptBlob(Data, finalKeyBytes, CryptoAlgo);
                        }
                    }
